<div class="">
    ...
    <a wire:navigate href="{{ route('page.products') }}">
        <div data-aos="fade-up" class="px-[15px] md:px-[50px] w-full h-[500px] xl:h-[250px] flex flex-col xl:justify-end group lg:h-full">
    ...
    <div data-aos="fade-up" id="partners">
        ...
        <div class="px-[15px] md:px-[50px] hidden xl:block">
        ...
        <div class="px-[15px] md:px-[50px] xl:hidden">
            <div class="w-full h-full bg-[#F8F1E5] rounded-2xl flex text-black flex-col p-5">
                <p class="text-xl md:text-2xl">Александр Игнатов - финансовый консультант по инвестициям в Долларах и Евро. Иностранные карты, валютные депозиты.</p>
                <div class="">
                    ...
                    <div class="flex justify-between flex-col">
                        <div class="flex ">
                            <div class="">
                                <img src="{{ asset('images/Rectangle 74.png') }}" class="object-cover w-20 h-20  rounded-full" alt="partner">
                            </div>
                            <div class="flex flex-col gap-1">
                                <p class="text-md font-medium">Александр Игнатов</p>
                                <p class="text-md">Финансовый консультант</p>
                            </div>
                        </div>
                        <div class="flex items-end h-full">
                            <a href="#" class="text-xl/6 font-semibold text-[#F8F1E5] bg-[#00343A] px-6 py-4 rounded-full flex gap-2 items-center hover:scale-105 transition duration-300 ease-in-out"><img class="w-6 h-6" src="{{ asset('images/telegram-logo-24.png') }}" alt="">@Ignatov_as</a>
    ...
    <div data-aos="fade-up" class="flex w-full justify-center items-center py-[200px] px-[15px] md:px-[50px]">
        <hr class="w-full border-[1px] border-[#F8F1E5]">
