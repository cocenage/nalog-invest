...
<div class="pt-[20px] md:pt-[100px]">
        ...
        <ol class="list-reset flex ">
            ...
            <li class="group">
                <a
                    ...
                    class="text-[#E3BF46] group-hover:text-[#F7F7F7] transition duration-300 ease-in-out">Услуги
                    <span class="mx-2 text-[#E3BF46] group-hover:text-[#F7F7F7] transition duration-300 ease-in-out">/</span>
                </a>
            </li>
    ...
    <div class="px-[15px] md:px-[50px] xl:grid grid-cols-12 gap-5 pt-[15px] pb-[100px]">
        <div class="col-span-10 flex flex-col gap-[30px]">
            <h1>{{ $product->name}}</h1>
            <h2 class="break-words">{{ $product->description}}</h2>
        </div>
    </div>
    ...
    <div class="mt-[50px]">
        <div class="bg-[#F7F7F7] flex flex-col xl:grid xl:grid-cols-12 gap-5 items-center mx-[15px] md:mx-[50px] h-[150px] xl:h-[250px] rounded-[15px] justify-center">
