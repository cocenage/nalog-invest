<footer class="w-full h-full">
    <div class="bg-[#F7F7F7] h-full text-black p-[15px] md:p-[50px] rounded-[15px] m-[15px] md:m-[0px] md:rounded-none">
        <p class="text-2xl lg:text-3xl 2xl:text-4xl font-medium pb-[15px] md:pb-[50px] lg:pb-[100px]">Налоговые решения для вашего финансового роста</p>
        ...
        <div class="flex flex-col sm:flex-row md:grid md:grid-cols-12 gap-[15px] md:gap-[30px] xl:gap-5 pt-[25px] md:pt-[50px] lg:pt-[100px] justify-between">
            <div class="col-span-4">
                <p class="text-2xl xl:text-3xl font-medium">Навигация</p>
                <ul class="pt-[15px] text-2xl">
                    <li class="mb-2">
                        <a wire:navigate href="{{ route('page.about') }}" class="text-[#333333] hover:text-black inline-block transition-transform duration-300 hover:translate-x-2">Обо мне</a>
                    </li>
                    <li class="mb-2">
                        <a wire:navigate href="{{ route('page.contacts') }}" class="text-[#333333] hover:text-black inline-block transition-transform duration-300 hover:translate-x-2">Контакты</a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('page.home') }}#reviews"  class="text-[#333333] hover:text-black inline-block transition-transform duration-300 hover:translate-x-2">Отзывы</a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('page.home') }}#partners" class="text-[#333333] hover:text-black inline-block transition-transform duration-300 hover:translate-x-2">Партнёры</a>
                    </li>
                </ul>
            </div>
            <div class="col-span-4">
        ...
        <div class="pt-[50px] md:pt-[100px] flex-col text-sm text-[#736C6A] flex lg:flex-row justify-between items-center">
            <div class="flex gap-[15px] lg:items-center lg:flex-row flex-col items-start w-full  lg:w-max">
            ...
            <hr class="w-full border-[1px] border-[#1e151533] lg:hidden">
            <p class="hidden lg:block">|</p>
            <livewire:document.document-list />
            </div>
            <div class=" pt-[10px]  lg:pt-0 lg:flex lg:justify-end w-full lg:w-max">
                <a href="https://t.me/cocenage" class="hover:text-[#27a7e7] duration-300" target="_blank">
                веб сайт от cocenage
                </a>
            </div>
        </div>
    </div>
