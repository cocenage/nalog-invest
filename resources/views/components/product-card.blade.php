@props(['data'])
<a class="hidden lg:block" wire:navigate href="{{ route('single.product', $data->slug) }}">
...
<a class="lg:hidden" wire:navigate href="{{ route('single.product', $data->slug) }}">
    <div data-aos="fade-up" class="px-[15px] md:px-[50px] w-full h-[full]  flex flex-col  group">
        <div class="flex h-[250px] flex-col justify-center">
            <div class="flex w-full justify-between">

                <p class="text-2xl font-medium xl:font-normal font-lg:text-3xl 2xl:text-4xl   leading-[1.5]  w-auto"> {{ $data->name }}</p>
